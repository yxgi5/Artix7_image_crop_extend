...
HD_PWD='/home/andy/workdir/hdmi_tx_ddr3/hdmi_tx_ddr3.runs/afifo_64i_32o_1024_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afifo_64i_32o_1024.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afifo_64i_32o_1024.tcl
