...
HD_PWD='/home/andy/workdir/hdmi_tx_ddr3/hdmi_tx_ddr3.runs/afifo_128i_32o_512_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afifo_128i_32o_512.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afifo_128i_32o_512.tcl
