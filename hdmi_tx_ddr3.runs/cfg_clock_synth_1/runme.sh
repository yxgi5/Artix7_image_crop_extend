...
HD_PWD='/home/andy/workdir/hdmi_tx_ddr3_1pcs_1920_1080_dual_ov5640_640_480_32bit_128burst/hdmi_tx_ddr3.runs/cfg_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cfg_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cfg_clock.tcl
