...
HD_PWD='/home/andy/workdir/hdmi_tx_ddr3/hdmi_tx_ddr3.runs/afifo_32i_64o_2048_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afifo_32i_64o_2048.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afifo_32i_64o_2048.tcl
